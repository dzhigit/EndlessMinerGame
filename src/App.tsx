...
function App() {
                ...
                : Math.floor(
                      Math.cbrt(
                          3 * (totalUpgradeLevelXp + 0.5) +
                              Math.sqrt(
                                  9 * (totalUpgradeLevelXp + 0.5) ** 2 - 1 / 27,
                              ),
                      ) +
                          Math.cbrt(
                              3 * (totalUpgradeLevelXp + 0.5) -
                                  Math.sqrt(
                                      9 * (totalUpgradeLevelXp + 0.5) ** 2 -
                                          1 / 27,
                                  ),
                          ) -
                          1,
    ...
    const updateClickers = useCallback(() => {
        ...
        setClickMultiplier(
            (prevMultiplier) =>
                clickers * clickersMultiplier +
                (pointsPerSecond * clickerBonus) / 100,
    ...
    function checkPointsForUpgrade(points, pointsRequired) {
        ...
        if (pointsRequired !== 0 && points >= pointsRequired) {
            ...
            setTotalLogLevelXp(
                (prevTotalLogLevelXp) =>
                    prevTotalLogLevelXp +
                    Math.log(Math.max(pointsRequired + 1, 1)),
    ...
    function upgradeClicker() {
        ...
        if (checkPointsForUpgrade(points, 10 * Math.pow(2, clickers - 1))) {
            ...
            checkUpgradeLevel(); //check if upgrade level has enough XP to level up
            setPoints(
                (prevPoints) => prevPoints - 10 * Math.pow(2, clickers - 1),
            ); //spend points
    ...
    function upgradeClickerMultiplier() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                100 * Math.pow(2, clickersMultiplier - 1),
            )
        ) {
            setTotalUpgradeLevelXp(
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 100 * Math.pow(2, clickersMultiplier - 1),
            ); //spend points
    ...
    function upgradeAutoClicker(level) {
        ...
        if (
            ...
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
                    prevTotalUpgradeLevelXp +
                    autoClickers[level - 1].value * level,
            ...
            setPoints(
                (prevPoints) =>
                    ...
                    100 *
                        Math.pow(
                            2,
                            autoClickersMultiplier[level - 1].value - 1,
                        ) *
                        Math.pow(10, level - 1),
            );
            setAutoClickersMultiplier((prevAutoClickersMultiplier) =>
                prevAutoClickersMultiplier.map((lvl) =>
                    lvl.level === level
                        ? Object.assign({}, lvl, {
                              value:
                                  prevAutoClickersMultiplier[lvl.level - 1]
                                      .value + 1,
                          })
                        : lvl,
                ),
            ...
            setAutoClickersLevelBonus((prevAutoClickersLevelBonus) =>
                prevAutoClickersLevelBonus.map((lvl) =>
                    lvl.level === level
                        ? Object.assign({}, lvl, {
                              value:
                                  prevAutoClickersLevelBonus[lvl.level - 1]
                                      .value + 1,
                          })
                        : lvl,
                ),
    ...
    function upgradeAutoClickerBonus(level) {
        ...
        if (
            ...
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
                    prevTotalUpgradeLevelXp +
                    autoClickersBonus[level - 1].value * level,
            ...
            setAutoClickersBonus((prevAutoClickersBonus) =>
                prevAutoClickersBonus.map((lvl) =>
                    lvl.level === level
                        ? Object.assign({}, lvl, {
                              value:
                                  prevAutoClickersBonus[lvl.level - 1].value +
                                  1,
                          })
                        : lvl,
                ),
            ...
            setPoints(
                (prevPoints) =>
                    ...
                    1e5 *
                        Math.pow(
                            5,
                            autoClickersBonusMultiplier[level - 1].value,
                        ) *
                        Math.pow(10, level - 1),
            );
            setAutoClickersBonusMultiplier((prevAutoClickersBonusMultiplier) =>
                prevAutoClickersBonusMultiplier.map((lvl) =>
                    lvl.level === level
                        ? Object.assign({}, lvl, {
                              value:
                                  prevAutoClickersBonusMultiplier[lvl.level - 1]
                                      .value + 1,
                          })
                        : lvl,
                ),
    ...
    function upgradeTimeMultiplierBonus() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                2.5e3 * Math.pow(10, timeMultiplierBonus),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 2.5e3 * Math.pow(10, timeMultiplierBonus),
            );
    ...
    function upgradeClickMultiplierBonus() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                5e3 * Math.pow(10, clickMultiplierBonus),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 5e3 * Math.pow(10, clickMultiplierBonus),
            );
    ...
    function upgradeClickerBonus() {
        ...
        if (checkPointsForUpgrade(points, 1e3 * Math.pow(10, clickerBonus))) {
            ...
            checkUpgradeLevel(); //check if upgrade level has enough XP to level up
            setPoints(
                (prevPoints) => prevPoints - 1e3 * Math.pow(10, clickerBonus),
            );
    ...
    function upgradeSecondsMultiplier() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                1e5 * Math.pow(10, secondsMultiplier - 1),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 1e5 * Math.pow(10, secondsMultiplier - 1),
            );
    ...
    function upgradeClicksMultiplier() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                1e6 * Math.pow(10, clicksMultiplier - 1),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 1e6 * Math.pow(10, clicksMultiplier - 1),
            );
            setClicksMultiplier(
                (prevClicksMultiplier) => prevClicksMultiplier + 1,
            ); //increase clicks multiplier by 1
            setTotalUpgrades((prevTotalUpgrades) => prevTotalUpgrades + 1); //increase total upgrades by 1
            updateGameState(); //update game state data
        }
    }
    function upgradeTotalUpgradesMultiplier() {
        ...
        if (
            checkPointsForUpgrade(
                points,
                5e4 * Math.pow(10, totalUpgradesMultiplier),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setTotalUpgradesMultiplier(
                (prevTotalUpgradesMultiplier) =>
                    prevTotalUpgradesMultiplier + 1,
    ...
    function upgradeLogLevelMultiplier() {
        if (
            checkPointsForUpgrade(
                points,
                5e5 * Math.pow(10, logLevelMultiplier),
            )
        ) {
            setTotalUpgradeLevelXp(
                (prevTotalUpgradeLevelXp) =>
            ...
            setPoints(
                (prevPoints) =>
                    prevPoints - 2.5e4 * Math.pow(10, logLevelMultiplier),
            );
            setTotalUpgrades((prevTotalUpgrades) => prevTotalUpgrades + 1); //increase total upgrades by 1
    ...
    return (
        ...
        <div className="App">
            ...
            <button onClick={() => addPointsFromClick()}>
                Click to Add Points
            </button>
            <br />
            <tr>
                <td>
                    ...
                    <NumericDisplay
                        value={timeMultiplierBonus}
                        shortForm={false}
                    />
                    <br />
                    +0.01% points per second bonus per seconds upgrade
                    multiplier per second played
                    {/*upgrade time multiplier bonus*/}
                    <button onClick={() => upgradeTimeMultiplierBonus()}>
                        Upgrade Time Multiplier Bonus
                    </button>
                    <CostDisplay
                        cost={2.5e3 * Math.pow(10, timeMultiplierBonus)}
                    />
                </td>
                <td>
                    Click Multiplier Bonus:{" "}
                    <NumericDisplay
                        value={clickMultiplierBonus}
                        shortForm={false}
                    />
                    <br />
                    +0.01% points per second bonus per clicks upgrade multiplier
                    per click made
                    ...
                    <CostDisplay
                        cost={5e3 * Math.pow(10, clickMultiplierBonus)}
                    />
                </td>
                <td>
                    Clicker Bonus:{" "}
                    ...
                    <br />
                    +1% bonus points per second from click per clicker bonus
                    level
                ...
                <td>
                    ...
                    <CostDisplay
                        cost={1e5 * Math.pow(10, secondsMultiplier - 1)}
                    />
                </td>
                <td>
                    Clicks Multiplier:{" "}
                    <NumericDisplay
                        value={clicksMultiplier}
                        shortForm={false}
                    />
                    <br />
                    {/*upgrade clicks multiplier*/}
                    ...
                    <CostDisplay
                        cost={1e6 * Math.pow(10, clicksMultiplier - 1)}
                    />
                </td>
                <td>
                    Total Upgrades Multiplier:{" "}
                    <NumericDisplay
                        value={totalUpgradesMultiplier}
                        shortForm={false}
                    />
                    <br />
                    +0.1% points per second bonus per total upgrades multiplier
                    per total upgrades level
                    {/*upgrade total upgrades multiplier*/}
                    <button onClick={() => upgradeTotalUpgradesMultiplier()}>
                        Upgrade Total Upgrades Multiplier
                    </button>
                    <CostDisplay
                        cost={5e4 * Math.pow(10, totalUpgradesMultiplier)}
                    />
                </td>
                <td>
                    Level Upgrade Multiplier:{" "}
                    <NumericDisplay
                        value={upgradeLevelMultiplier}
                        shortForm={false}
                    />
                    <br />
                    +1% points per second bonus per level upgrade multiplier
                    upgrade per upgrade level
                    {/*upgrade level upgrades multiplier*/}
                    <button onClick={() => upgradeLevelUpgradeMultiplier()}>
                        Upgrade Level Upgrade Multiplier
                    </button>
                    <CostDisplay
                        cost={2.5e4 * Math.pow(10, upgradeLevelMultiplier)}
                    />
                </td>
                <td>
                    Log Level Multiplier:{" "}
                    <NumericDisplay
                        value={logLevelMultiplier}
                        shortForm={false}
                    />
                    <br />
                    +1% points per second bonus per log level multiplier upgrade
                    per log level
                    <br />
                    ...
                    <CostDisplay
                        cost={5e5 * Math.pow(10, logLevelMultiplier)}
                    />
                </td>
            </tr>
            <table>
                <thead>
                    <tr>
                        <th>
                            Item (1% bonus per autoclicker upgrade per bonus
                            multiplier upgrade)
                        </th>
                        <th>
                            Multiplier (2% bonus per multiplier upgrade per
                            bonus multiplier upgrade)
                        </th>
                        <th>
                            Level Bonus (1% bonus per autoclicker level, 3%
                            bonus per level bonus upgrade per bonus multiplier
                            upgrade)
                        </th>
                        <th>
                            Bonus (1% bonus per upgrade, 4% bonus per bonus
                            upgrade per bonus multiplier upgrade)
                        </th>
                        <th>
                            Bonus Multiplier (5% bonus per bonus multiplier
                            upgrade)
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            ...
                            <CostDisplay
                                cost={10 * Math.pow(2, clickers - 1)}
                            />
                        </td>
                        <td>
                            Clicker Multiplier Level:{" "}
                            <NumericDisplay
                                value={clickersMultiplier}
                                shortForm={false}
                            />
                            <br />
                            ...
                            <CostDisplay
                                cost={100 * Math.pow(2, clickersMultiplier - 1)}
                            />
                        </td>
                    </tr>
                    {Array.from({ length: maxLevel }, (_, i) => (
                        <tr key={i + 1}>
                            <td>
                                ...
                                <button
                                    onClick={() => upgradeAutoClicker(i + 1)}
                                >
                                    Upgrade Autoclicker
                                </button>
                                <CostDisplay
                            ...
                            <td>
                                ...
                                <button
                                    onClick={() =>
                                        upgradeAutoClickerMultiplier(i + 1)
                                    }
                                >
                                    Upgrade Autoclicker Multiplier
                                </button>
                                <CostDisplay
                                    cost={
                                        ...
                                        Math.pow(
                                            2,
                                            autoClickersMultiplier[i].value - 1,
                                        ) *
                                        Math.pow(10, i)
                                    }
                                />
                            ...
                            <td>
                                ...
                                <button
                                    onClick={() =>
                                        upgradeAutoClickerLevelBonus(i + 1)
                                    }
                                >
                                    Upgrade Autoclicker Level Bonus
                                </button>
                                <CostDisplay
                                    cost={
                                        ...
                                        Math.pow(
                                            2,
                                            autoClickersLevelBonus[i].value,
                                        ) *
                                        Math.pow(10, i)
                                    }
                                />
                            ...
                            <td>
                                ...
                                <button
                                    onClick={() =>
                                        upgradeAutoClickerBonusMultiplier(i + 1)
                                    }
                                >
                                    Upgrade Autoclicker Bonus Multiplier
                                </button>
